...
export default function RegisterPage({ isFormRegisterVisibleParam }) {
  ...
  return (
    <div className="fixed flex justify-center items-center max-h-screen">
      {isFormRegisterVisible && (
        <>
          <motion.div
            className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 h-full w-full rounded-3xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <div className="bg-gray-200  h-full flex items-center justify-center relative z-50">
              {isLoading && (
              ...
              <div className="flex h-3/5 bg-white shadow-lg rounded-lg flex-col justify-center  lg:px-8 w-full">
                ...
                <div className="mt-10 max-h-screen sm:mx-auto sm:w-full sm:max-w-full  min-w-full">
